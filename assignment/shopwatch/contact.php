            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php if(isset($_GET['message']) == "fill") { ?>
                                <h2 style="color: red;"><?php echo "Please fill all the textbox"?></h2>
                        <?php } else if(isset($_GET['message'])=="S") { ?>
                                <h2 style="color: green;"><?php echo "Your message is send successfully"?></h2>
                        <?php } else if (isset($_GET['message'])=="F") { ?>
                                <h2 style="color: red;"><?php echo "Failed to send"?></h2>
                        <?php } ?>
